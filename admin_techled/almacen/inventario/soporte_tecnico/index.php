...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                <h1 class="m-0">Inventario General Almacén Soporte Técnico</h1>                
                            ...
                            <table id="table_stcs" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = $pdo->prepare('SELECT 
                                                            ...
                                                            LEFT JOIN
                                                                referencias_fuente AS refefuentes ON al_st.producto = refefuentes.id_referencias_fuentes AND al_st.tipo_producto = 3;
                                    ...
                                    foreach ($almacenes_pricipales as $almacen_pricipal){
                                        $id = $almacen_pricipal['id_soporte_tecnico'];

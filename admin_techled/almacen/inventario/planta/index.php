...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                <h1 class="m-0">Inventario General Almacén Planta</h1>                
                            ...
                            <table id="table_stcs" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = $pdo->prepare('SELECT 
                                                            ...
                                                            CASE
                                                                when al_pla.tipo_producto = 1 then caracmodulos.serie_modulo
                                                                when al_pla.tipo_producto = 2 then refecontrol.referencia
                                                                when al_pla.tipo_producto = 3 then refefuentes.modelo_fuente
                                                                else null
                                                            end as nombre_producto
                                                            FROM
                                                                alma_planta AS al_pla
                                                            INNER JOIN
                                                                t_productos AS productomovido ON al_pla.tipo_producto = productomovido.id_producto
                                                            LEFT JOIN
                                                                caracteristicas_modulos AS caracmodulos ON al_pla.producto = caracmodulos.id_car_mod AND al_pla.tipo_producto = 1
                                                            LEFT JOIN
                                                                referencias_control AS refecontrol ON al_pla.producto = refecontrol.id_referencia AND al_pla.tipo_producto = 2
                                                            LEFT JOIN
                                                                referencias_fuente AS refefuentes ON al_pla.producto = refefuentes.id_referencias_fuentes AND al_pla.tipo_producto = 3;

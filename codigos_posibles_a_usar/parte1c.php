            ...
            <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'ADMINISTRACIÓN')): ?>
                        ...
                        <?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'ALMACÉN')): ?>
                      ...
                      ?>
                        ...
                        <?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'OPERACIÓN')): ?>
...
<?php endif; ?>
                    ...
                    <?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'ATENCIÓN CLIENTE')): ?>
...
<?php endif; ?>
                      ...
                      <?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'VISITA TÉCNICA')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'CRM')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'DISEÑO INDUSTRIAL')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'PRODUCTO')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'PROYECTO')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'TI')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'TECHLED')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'PLANTA')): ?>
...
<?php endif; ?>
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'TÉCNICO')): ?>
...
<?php if (tiene_permiso($pdo,$id_rol_sesion_usuario, 'CLIENTE')): ?>
...
<?php if (tiene_permiso($pdo, $id_rol_sesion_usuario, 'INGRESO PRODUCTO')): ?>
...
<?php
function tiene_permiso($pdo, $rol_id, $permiso_nombre) {
    // Prepara la consulta con marcadores de posición
    $query = $pdo->prepare('
        SELECT 1
        FROM menu_roles_permisos rp
        INNER JOIN menu_permisos p ON rp.permiso_id = p.id
    ...
    // Devuelve true si existe al menos un registro

                    ...
                    <form action="controller_edit.php" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_url" value="<?php echo $nombre_url;?>" class="form-control" placeholder="Nombre URL">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">URL</label>
                                    <input type="text" name="url" value="<?php echo $url;?>" class="form-control" placeholder="URL">
                                </div>
                            </div>
                        </div>

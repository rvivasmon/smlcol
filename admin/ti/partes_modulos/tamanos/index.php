...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                <h1 class="m-0">Tamaños Disponibles</h1>
                            ...
                            <div class="table-responsive">
                                <table id="table_usuarios" class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $contador = 0;
                                        $query = $pdo->prepare('SELECT * FROM tabla_tamanos_modulos WHERE tamanos_modulos IS NOT NULL AND tamanos_modulos != "" ORDER BY tamanos_modulos	');
                                        $query->execute();
                                        $tamanos = $query->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($tamanos as $tamano){
                                            $id = $tamano['id'];
                                            $nombre_tamano = $tamano['tamanos_modulos'];
                                            $habilitado = $tamano['habilitar_tamano'];
                                            $contador = $contador + 1;
                                        ?>
                                            <tr>
                                                <td><?php echo $contador; ?></td>
                                                <td><?php echo $nombre_tamano; ?></td>
                                                <td>

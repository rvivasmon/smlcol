            ...
            <div class="row mb-2">
                ...
                <h1 class="m-1">TRATAMIENTO DE OST - SMARTLED</h1>
                            ...
                            <div class="table-responsive">
                                <table id="table_traost" class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $contador = 0;
                                        $query = $pdo->prepare('SELECT ost.*, t_tipo_servicio.servicio_ost AS nombre_servicio, tecnicos.nombre AS nombre_tecnicos, t_estado.estadoost AS nombre_estado FROM ost JOIN t_tipo_servicio ON ost.tipo_servicio = t_tipo_servicio.id JOIN t_estado ON ost.estado = t_estado.id JOIN tecnicos ON ost.tecnico_tratante = tecnicos.id WHERE ost.estado_ticket IN (1)');
                    ...
                    <div class="card card-blue">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="table_traost1" class="table table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>ID OST</th>
                                            ...
                                            <th>Estado</th>
                                            <th>Persona Contacto</th>
                                            <th>Medio Contacto</th><th><center>Acciones</center></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        $contador = 0;
                                        $query = $pdo->prepare('SELECT ost.*, t_tipo_servicio.servicio_ost AS nombre_servicio, tecnicos.nombre AS nombre_tecnicos, t_estado.estadoost AS nombre_estado FROM ost JOIN t_tipo_servicio ON ost.tipo_servicio = t_tipo_servicio.id JOIN t_estado ON ost.estado = t_estado.id JOIN tecnicos ON ost.tecnico_tratante = tecnicos.id WHERE ost.estado_ticket IN (2)');

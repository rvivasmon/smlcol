...
$query = $pdo->prepare("SELECT ost.*, t_tipo_servicio.servicio_ost AS nombre_servicio, t_estado.estadoost AS nombre_estado FROM ost JOIN t_tipo_servicio ON ost.tipo_servicio = t_tipo_servicio.id JOIN t_estado ON ost.estado = t_estado.id  WHERE ost.id = '$id_get'");

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $estado_factura = $_POST['estado_factura1'];
        ...
        if (count($_POST['descripcion']) > 0 && count($_POST['cantidad']) > 0 && count($_POST['instalacion']) > 0) {
            ...
            for ($i = 0; $i < count($descripciones); $i++) {
                ...
                $query_insert_item = $pdo->prepare('INSERT INTO items_oc (descripcion, cantidad, instalacion, contador, id_oc) VALUES (:descripcion, :cantidad, :instalacion, :contador, :id_oc)');

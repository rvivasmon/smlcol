            ...
            <div class="card card-blue">
                ...
                <div class="card-body">
                    <form action="controller_delete_oc.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="usuario_elimina_oc">Usuario Elimina OC</label>
                                    <input type="text" name="usuario_elimina_oc" id="usuario_elimina_oc" value="<?php echo $sesion_usuario['nombre']?>" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="oc_resultante">OC</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="num_telefono">Num Telefono</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="lugar_instalacion">Lugar Instalacion</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="estado_logistico">Estado Logistico</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="num_items">Num Items</label>

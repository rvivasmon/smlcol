...
$medio_ingreso = $_POST['op'];
$ticket_externo = $_POST['tipo'];
$servicio = $_POST['descripcion'];
$id_producto = $_POST['cantidad'];
$falla = $_POST['procesada'];
/*$observacion = $_POST['enproduccion'];

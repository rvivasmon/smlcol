    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card card-success" style="width: 120rem;">
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group cloned-section">
                                                <div class="row">
                                                    <div class="col-md-2 items_pre">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="id_tracking" name="id_tracking" value="<?php echo $id; ?>">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="entrada_md" name="entrada_md" class="form-control" value="<?php echo $cantidad; ?>">
                                                        </div>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="modelo_nombre" class="d-block mb-0">Marca - Modelo / Referencia - Pitch</label>
                                                            <input type="text" id="modelo_nombre" name="modelo_nombre" class="form-control" value="<?php echo $modelo_nombre; ?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="pitch" name="pitch" class="form-control pitch">
                                                                ...
                                                                $selected3 = ($pit['pitch'] == $pitch) ? 'selected' : ''; 
                                                                    echo '<option value="' . $pit['pitch'] . '" ' . $selected3 . '>' . $pit['pitch'] . '</option>';
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="smd_encap">SMD Encapsulado</label>
                                                            <input type="text" id="smd_encap" name="smd_encap" class="form-control smd_encap" value="<?php echo $smd_encapsulado; ?>" >
                                                        </div>                                                        
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="interface_h">Interface Hub</label>
                                                            <input type="text" id="interface_h" name="interface_h" class="form-control interface_h" value="<?php echo $interface_hub; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="grupo_datos">Grupo Datos</label>
                                                            <input type="text" id="grupo_datos" name="grupo_datos" class="form-control grupo_datos" value="<?php echo $grupo_datos; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="nits">Nits Brillo</label>
                                                            <input type="text" id="nits" name="nits" class="form-control nits" value="<?php echo $nits_brillo; ?>" >
                                                        </div>                                                        
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="c_shinkong">Corriente Shinkong</label>
                                                            <input type="text" id="c_shinkong" name="c_shinkong" class="form-control c_" value="<?php echo $corriente_shinkong; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="c_king">Corriente Kinglight</label>
                                                            <input type="text" id="c_king" name="c_king" class="form-control c_" value="<?php echo $corriente_kinglight; ?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="c_nation" name="c_nation" class="form-control c_" value="<?php echo $corriente_nationstar; ?>" >
                                                        </div>                                                        
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="num_mod_5v40a">Num Mod 5v40a</label>
                                                            <input type="text" id="num_mod_5v40a" name="num_mod_5v40a" class="form-control num_mod_5v40a" value="<?php echo $num_mod_5v40a; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="num_mod_5v60a">Num Mod 5v60a</label>
                                                            <input type="text" id="num_mod_5v60a" name="num_mod_5v60a" class="form-control num_mod_5v60a" value="<?php echo $num_mod_5v60a; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="num_ic_control">Cantidad IC control</label>
                                                            <input type="text" id="num_ic_control" name="num_ic_control" class="form-control num_ic_control" value="<?php echo $cantidad_ic_control; ?>" >
                                                        </div>                                                        
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="mls">MLS</label>
                                                            <input type="text" id="mls" name="mls" class="form-control mls" value="<?php echo $mls; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="consumo_watts">Consumo Watts</label>
                                                            <input type="text" id="consumo_watts" name="consumo_watts" class="form-control consumo_watts" value="<?php echo $consumo_watts; ?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="ref_5v" name="ref_5v" class="form-control ref_5v" value="<?php echo $ref_alim_5v; ?>" >
                                                        </div>                                                        
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="refe_cable">Referencia cable</label>
                                                            <input type="text" id="refe_cable" name="refe_cable" class="form-control refe_cable" value="<?php echo $referencia_cable; ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 items_pre campoModulo">
                                                        <div class="form-group">
                                                            <label for="estan_magnet">Standard magnet</label>
                                                            <input type="text" id="estan_magnet" name="estan_magnet" class="form-control estan_magnet" value="<?php echo $estan_magnet; ?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="marca_control" name="marca_control" class="form-control" >
                                                                ...
                                                                $selected6 = ($mar_control['marca_control'] == $marca_control) ? 'selected' : '';
                                                                    echo '<option value="' . $mar_control['marca_control'] . '" ' . $selected6 . '>' . $mar_control['marca_control'] . '</option>'; 
                                                                }
                                                                ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="referencia_control35" name="referencia_control35" class="form-control" >
                                                                ...
                                                                $selected7 = ($refere_control['referencia'] == $ref_control) ? 'selected' : '';
                                                                    echo '<option value="' . $refere_control['referencia'] . '" ' . $selected7 . '>' . $refere_control['referencia'] . '</option>';
                                                                } 
                                                                ?>
                                                            </select>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="marca_fuente" name="marca_fuente" class="form-control">
                                                                    ...
                                                                    $selected8 = ($marc_fuente['marca_fuente'] == $marca_fuente) ? 'selected' : ''; 
                                                                        echo '<option value="' . $marc_fuente['marca_fuente'] . '" ' . $selected8 . '>' . $marc_fuente['marca_fuente'] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="modelo_fuente35" name="modelo_fuente35" class="form-control">
                                                                    ...
                                                                    $selected9 = ($mod_fuente['modelo_fuente'] == $modelo_fuente) ? 'selected' : '';
                                                                        echo '<option value="' . $mod_fuente['modelo_fuente'] . '" ' . $selected9 . '>' . $mod_fuente['modelo_fuente'] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="obscolombia" class="form-control" rows="8" required><?php echo $observaciones_colombia;?></textarea>
                                    </div>
                                </div>
                            </div>                        
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        let marcaControl = document.getElementById("marca_control");
        let referenciaControl35 = document.getElementById("referencia_control35");
        let marcaFuente = document.getElementById("marca_fuente");
        let modeloFuente35 = document.getElementById("modelo_fuente35");
        let modeloNombreInput = document.getElementById("modelo_nombre"); // Campo oculto o visible donde se mostrará el resultado

        function actualizarModeloNombre() {
            let modeloNombre = "N/A"; // Valor por defecto

            if (modelo?.value && pitch?.value && modelo.value !== "Seleccione una Categoría") {
                modeloNombre = `${modelo.value} / ${pitch.value}`;
            } else if (marcaControl?.value && referenciaControl35?.value && marcaControl.value !== "Seleccione una Categoría") {
                modeloNombre = `${marcaControl.value} / ${referenciaControl35.value}`;
            } else if (marcaFuente?.value && modeloFuente35?.value && marcaFuente.value !== "Seleccione una Categoría") {
                modeloNombre = `${marcaFuente.value} / ${modeloFuente35.value}`;
            }

            modeloNombreInput.value = modeloNombre; // Actualiza el campo con el resultado
        }

        // Escuchar eventos de cambio en los campos relevantes
        [modelo, pitch, marcaControl, referenciaControl35, marcaFuente, modeloFuente35].forEach(elemento => {
            if (elemento) {
                elemento.addEventListener("change", actualizarModeloNombre);
            }
        });

        // Ejecutar la función una vez al cargar la página para establecer un valor inicial
        actualizarModeloNombre();
    });

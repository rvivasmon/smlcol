...
$sql = "INSERT INTO tracking (date, origin, type, category, quantitly, usuario, observaciones_colombia) VALUES (:fecha_ingreso, :destino_mercancia, :tipo_producto, :categoria_2, :cantidad, :usuario_operador, :obscolombia)";
...
$sentencia->bindParam(':categoria_2', $categoria_2);

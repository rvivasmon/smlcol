...
include('../../../../layout/admin/parte1.php');
    ...
    $query = $pdo->prepare('SELECT consecu_entra FROM movimiento_admon ORDER BY consecu_entra DESC LIMIT 1');
    $query->execute();
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="entrada_md" class="form-control" placeholder="Entrada" required>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function limpiarCampos() {
            ...
            $('input[type="text"]').not('#contador_entra').val('');  // Limpiar campos de texto excepto 'producto'
            $('input[type="number"]').val(''); // Limpiar campos numéricos
            $('input[type="file"]').val('');   // Limpiar campo de archivo
            $('select').not('#producto, #almacen_entra, #bodega, #sub_almacen').val(''); // Limpiar selects excepto 'producto'

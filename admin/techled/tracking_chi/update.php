...
$sql = "UPDATE tracking 
        SET num_envoys = ?, ship = ?, guia = ?, fecha_guia = ?, observaciones_china = ?, fecha_envio = ?, enviar = ?, estado = ? 
        WHERE id IN ($placeholders)";

$stmt = $pdo->prepare($sql);
$params = [$num_envoys, $ship, $guia, $fecha_guia, $obschina, $fecha_envio, $enviar, $estado];

...
date_default_timezone_set('America/Bogota'); // Ajusta si estás en otra zona
$anioMes = date('Ym'); // Año y mes actual (ej: 202504)

// 1. Consulta el último contador
$query = $pdo->prepare("SELECT MAX(contador_china) AS max_contador FROM tracking");
$query->execute();
$resultado = $query->fetch(PDO::FETCH_ASSOC);

$contador_china = (int)$resultado['max_contador'];
$contador_china = ($contador_china <= 0) ? 1 : $contador_china + 1;

// 2. Armas el código
$codigo_chino = "TLCH" . "-" . $anioMes . "-" . str_pad($contador_china, 3, '0', STR_PAD_LEFT);
                      ...
                      <div class="card card-blue">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="card-tools d-flex justify-content-center w-100">
                                ...
                                <!-- Botón existente para crear regresar -->
                          ...
                          <div class="table-responsive">
                            <table id="table_tracking" class="table table-striped table-hover table-bordered">
                              ...
                              <tbody>
                                <?php
                                $contador = 0;
                                $query = $pdo->prepare('SELECT * FROM tracking WHERE finished = "1" AND enviar = "0"');
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <center>
                                          ...
                                          <a class="btn btn-danger btn-sm" <?php echo $disable_enviar; ?>>Enviar <i class="fas fa-ship"></i></a>
                                        </center>
                                      </td>
                                      <td>
...
<!-- Modal HTML guía envío de China-->
      ...
      <div class="modal-body">
        <form id="editForm">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="doc_envio" name="doc_envio" value="<?php echo $codigo_chino; ?>" readonly>
            <input type="hidden" class="form-control" id="contador_china" name="contador_china" value="<?php echo $contador_china; ?>" readonly>
          </div>
          <div class="form-group">

                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 campo Modulo">
                                            <div class="form-group">
                                                ...
                                                <input type="pitch_modulo" id="pitch_modulo" name="pitch_modulo" class="form-control" placeholder="pitch_modulo" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 campo Modulo">
                                            <div class="form-group">
                                                ...
                                                <input type="modelo_modulo" id="modelo_modulo" name="modelo_modulo" class="form-control" placeholder="modelo_modulo" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 campo Control">
                                            <div class="form-group">
                                                ...
                                                <input type="marca_control" id="marca_control" name="marca_control" class="form-control" placeholder="Marca" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 campo Control">
                                            <div class="form-group">
                                                ...
                                                <input type="funcion_control" id="funcion_control" name="funcion_control" class="form-control" placeholder="Función" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 campo Fuente">
                                            <div class="form-group">
                                                <label for="">Marca</label>
                                                <input type="marca_fuente" id="marca_fuente" name="marca_fuente" class="form-control" placeholder="Marca" >
                                            </div>
                                        </div>

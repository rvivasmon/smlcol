...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                <h1 class="m-0">ROP por procesar</h1>
                                ...
                                <table id="table_pop" class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($popes as $pop_item) {
                                            ...
                                            $id = $pop_item['id'];
                                            $id_pop = $pop_item['item_pop'];
                                            $op = $pop_item['op'];
                                            $item_pop = $pop_item['oc'];
                                            $fecha_recibido = $pop_item['fecha'];
                                            $tipo_estructura = $pop_item['modulo'];
                                            $cantidad = $pop_item['receiving'];
                                            $numero_items = $pop_item['cantidad_modulo']; // Número de veces que se repite id_pop
                                            $contador = $contador + 1;
                                        ?>
                                            <tr>

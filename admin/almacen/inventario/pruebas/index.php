                            ...
                            <table id="table_stcs" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = $pdo->prepare('SELECT 
                                                            ...
                                                            CASE
                                                                when al_pru.tipo_producto = 1 then caracmodulos.serie
                                                            ...
                                                            LEFT JOIN
                                                                producto_modulo_creado AS caracmodulos ON al_pru.producto = caracmodulos.id AND al_pru.tipo_producto = 1
                                                            LEFT JOIN

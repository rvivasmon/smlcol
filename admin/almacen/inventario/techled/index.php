...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                <h1 class="m-0">Inventario General Almacén Techled</h1>                
                            ...
                            <table id="table_stcs" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = $pdo->prepare('SELECT 
                                                            ...
                                                            LEFT JOIN
                                                                referencias_fuente AS refefuentes ON altec.producto = refefuentes.id_referencias_fuentes AND altec.tipo_producto = 3;

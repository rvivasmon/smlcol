...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                <h1 class="m-0">Inventario General Almacén Aliados</h1>                
                            ...
                            <table id="table_stcs" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = $pdo->prepare('SELECT 
                                                            ...
                                                            CASE
                                                                when al_ali.tipo_producto = 1 then caracmodulos.serie_modulo
                                                                when al_ali.tipo_producto = 2 then refecontrol.referencia
                                                                when al_ali.tipo_producto = 3 then refefuentes.modelo_fuente
                                                                else null
                                                            end as nombre_producto
                                                            FROM
                                                                alma_aliados AS al_ali
                                                            INNER JOIN
                                                                t_productos AS productomovido ON al_ali.tipo_producto = productomovido.id_producto
                                                            LEFT JOIN
                                                                caracteristicas_modulos AS caracmodulos ON al_ali.producto = caracmodulos.id_car_mod AND al_ali.tipo_producto = 1
                                                            LEFT JOIN
                                                                referencias_control AS refecontrol ON al_ali.producto = refecontrol.id_referencia AND al_ali.tipo_producto = 2
                                                            LEFT JOIN
                                                                referencias_fuente AS refefuentes ON al_ali.producto = refefuentes.id_referencias_fuentes AND al_ali.tipo_producto = 3;
                                    ...
                                    foreach ($almacenes_pricipales as $almacen_pricipal){
                                        $id = $almacen_pricipal['id_aliados'];

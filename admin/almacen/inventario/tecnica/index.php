                            ...
                            <table id="table_stcs" class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = $pdo->prepare('SELECT 
                                                            ...
                                                            CASE
                                                                when al_tec.tipo_producto = 1 then caracmodulos.serie
                                                            ...
                                                            LEFT JOIN
                                                                producto_modulo_creado AS caracmodulos ON al_tec.producto = caracmodulos.id AND al_tec.tipo_producto = 1
                                                            LEFT JOIN

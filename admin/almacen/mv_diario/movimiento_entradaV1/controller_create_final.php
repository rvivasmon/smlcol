...
$sql = "INSERT INTO movimiento_diario 
        (fecha, tipo_producto, pitch_modulo, serie_modulo, marca_control, marc_fuente1, modelo_fuente, almacen_origen1, cantidad_salida, almacen_destino1, cantidad_entrada, observaciones, id_usuario, op, referencia_1, referencia_2) 
        VALUES (:fecha, :producto, :pitch, :serie_modulo, :marca_control, :marca_fuente, :modelo_fuente, :almacen_salida_md, :salida_md, :almacen_entrada_md, :entrada_md, :observacion, :usuario, :op_destino, :referencia_1, :referencia_2)";
...
if ($sentencia->execute()) {
    ...
    $_SESSION['msj'] = "Registro realizado correctamente";
    header('Location: ' . $URL . 'admin/almacen/mv_diario');
} else {
    $_SESSION['error'] = "Error al realizar el registro";

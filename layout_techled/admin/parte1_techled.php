...
<!DOCTYPE html>
  <html lang="es">
    <head>
      ...
      <!-- Icon Logo -->
      <link rel="icon" type="image/ico" href="../../public/images/TechLogo.png">
      ...
      <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
              <a href="#" class="nav-link">TECHLED COLOMBIA</a>
            </li>
          </ul>
          <!-- Right navbar links -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <a href="<?php echo $URL?>/admin" class="brand-link">
            <img src="<?php echo $URL?>/public/dist/img/techled_negro.png" alt="SML Logo" class="brand-image img-circle elevation-3" style="opacity: 1.9">
            <span class="brand-text font-weight-light">TL Col</span> 
          </a>
            ...
            <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <?php 
                      if( ($id_rol_sesion_usuario=="7") || ($id_rol_sesion_usuario=="7") ){ ?>
                      ...
                      ?>
                        ...
                        <li class="nav-item">
                          ...
                          <ul class="nav nav-treeview">
                                      ...
                                      <li class="nav-item">
                                          ...
                                          <ul class="nav nav-treeview">
                                              <?php foreach ($productos as $producto): ?>
                                                  ...
                                                  if ($almacen['id'] == 3) {
                                                      if ($producto['id'] == 1) {
                                                          $url_producto = $URL . "admin_techled/almacen/inventario/principal/index_modulos.php";
                                                      } elseif ($producto['id'] == 2) {
                                                          $url_producto = $URL . "admin_techled/almacen/inventario/principal/index_control.php";
                                                      } elseif ($producto['id'] == 3) {
                                                          $url_producto = $URL . "admin_techled/almacen/inventario/principal/index_fuentes.php";
                                                      } elseif ($producto['id'] == 6) {
                                                        $url_producto = $URL . "admin_techled/almacen/inventario/principal/index.php";
                                                    }
                                                      // Agregar más condiciones según sea necesario
                                                  } elseif ($almacen['id'] == 4) {
                                                    if ($producto['id'] == 1) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_modulos.php";
                                                  } elseif ($producto['id'] == 2) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_control.php";
                                                  } elseif ($producto['id'] == 3) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_fuentes.php";
                                                  } elseif ($producto['id'] == 6) {
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/techled/index.php";
                                                }
                                                  } elseif ($almacen['id'] == 5) {
                                                    if ($producto['id'] == 1) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_modulos.php";
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/importacion/index.php";
                                                }
                                                  } elseif ($almacen['id'] == 6) {
                                                    if ($producto['id'] == 1) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_modulos.php";
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/tecnica/index.php";
                                                }
                                                  } elseif ($almacen['id'] == 7) {
                                                    if ($producto['id'] == 1) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_modulos.php";
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/planta/index.php";
                                                }
                                                  } elseif ($almacen['id'] == 8) {
                                                    if ($producto['id'] == 1) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_modulos.php";
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/pruebas/index.php";
                                                }
                                                  } elseif ($almacen['id'] == 9) {
                                                    if ($producto['id'] == 1) {
                                                      $url_producto = $URL . "admin_techled/almacen/inventario/index_modulos.php";
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/desechados/index.php";
                                                }
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/soporte_tecnico/index.php";
                                                }
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/aliados/index.php";
                                                }
                                                    ...
                                                    $url_producto = $URL . "admin_techled/almacen/inventario/almacenes/index.php";
                                                }
                                                  }
                                                  ?>
                                                  <li class="nav-item">
                            ...
                            <li class="nav-item">
                              <a href="<?php echo $URL;?>admin_techled/almacen/mv_diario" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>

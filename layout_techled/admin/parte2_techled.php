          ...
          <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <?=$anio_actual;?> <a href="https://smartledcolombia.com">TechLed Colombia</a>.</strong> All rights reserved.
          </footer>
        </div>
        <!-- ./wrapper -->
        ...
        <script src="https://cdn.jsdelivr.net/npm/pdfmake@0.1.72/build/pdfmake.min.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/pdfmake@0.1.72/build/vfs_fonts.js"></script>
        ...
        <script src="https://cdn.jsdelivr.net/npm/datatables.net-buttons@2.2.2/js/buttons.colVis.min.js"></script>

<?php
	...
	*/
	...
	$aColumnas = array( 'id','id_stc', 'fecha_ingreso', 'medio_ingreso', 'ticket_externo', 'tipo_servicio', 'id_producto', 'falla', 'observacion', 'cliente', 'ciudad', 'proyecto', 'op', 'estado', 'persona_contacto', 'email_contacto' );
